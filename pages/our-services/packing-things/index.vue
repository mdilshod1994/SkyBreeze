...
<script>
import PackingPeculiarities from '../../../components/our-services/packing-things/PackingPeculiarities.vue'
...
export default {
    components: { ServicePromo, PackingPeculiarities, WhyApply, MainOrder, BreadCrumpBtnHome },
    data() {
        return {
            service: []
        }
